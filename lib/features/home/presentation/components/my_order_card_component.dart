...
class MyOrderCardComponent extends ConsumerWidget {
  const MyOrderCardComponent({
    required this.order,
    super.key,
  });
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isOnTheWay = order.deliveryStatus == DeliveryStatus.onTheWay;
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                isDelivered ? tr(context).delivered : tr(context).onTheWay,
            ...
            // Action buttons for orders on the way
            if (isOnTheWay) ...[
              const SizedBox(
                height: Sizes.marginV12,
              ),
