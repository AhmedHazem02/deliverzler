...
mixin _$ForgotPasswordState {
  DateTime? get lastSentTime => throw _privateConstructorUsedError;
...
abstract class $ForgotPasswordStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({DateTime? lastSentTime, bool emailSent});
}
...
class _$ForgotPasswordStateCopyWithImpl<$Res, $Val extends ForgotPasswordState>
  ...
  @override
  $Res call({
    Object? lastSentTime = freezed,
    Object? emailSent = null,
  }) {
    return _then(_value.copyWith(
      lastSentTime: freezed == lastSentTime
          ? _value.lastSentTime
          : lastSentTime // ignore: cast_nullable_to_non_nullable
              as DateTime?,
...
class _$ForgotPasswordStateImpl implements _ForgotPasswordState {
  const _$ForgotPasswordStateImpl({this.lastSentTime, this.emailSent = false});
  ...
  @override
  String toString() {
    return 'ForgotPasswordState(lastSentTime: $lastSentTime, emailSent: $emailSent)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.lastSentTime, lastSentTime) ||
                other.lastSentTime == lastSentTime) &&
            (identical(other.emailSent, emailSent) ||
                other.emailSent == emailSent));
  }

  @override
  int get hashCode => Object.hash(runtimeType, lastSentTime, emailSent);
...
abstract class _ForgotPasswordState implements ForgotPasswordState {
  const factory _ForgotPasswordState(
      {final DateTime? lastSentTime,
      final bool emailSent}) = _$ForgotPasswordStateImpl;
