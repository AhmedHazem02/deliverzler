...
class UserDto with _$UserDto {
  ...
  /// Standard factory for JSON deserialization - generated by json_serializable
  factory UserDto.fromJson(Map<String, dynamic> json) =>
      _$UserDtoFromJson(json);
  
  /// Factory that handles both UserDto format and DriverApplication format
  /// DriverApplication uses 'photoUrl' and 'userId', UserDto uses 'image' and 'id'
  factory UserDto.fromFirestoreData(Map<String, dynamic> json) {
    final normalizedJson = <String, dynamic>{
      ...json,
      // Use 'id' or fallback to 'userId'
      'id': json['id'] ?? json['userId'] ?? '',
      // Use 'image' or fallback to 'photoUrl'
